...
CREATE TABLE `tblvendor` (
  ...
  `fld_gender` varchar (10),
  `fld_address` varchar(50) NOT NULL,
  `fld_logo` varchar(250)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tblvendor` (`fldvendor_id`, `fld_name`, `fld_email`, `fld_password`, `fld_mob`, `fld_gender`, `fld_address`, `fld_logo`) VALUES
(22, 'Hotel Radison', 'vendor1@gmail.com', 'vendor1', 7503515386, 'male', 'noida', '46388969.jpg'),
(23, 'Hotel Piccaso', 'vendor2@gmail.com', 'vendor2', 7503515385, 'female', 'C-33, SWARN PARK, MUNDKA', '46388969.jpg');
