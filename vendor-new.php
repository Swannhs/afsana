    ...
    if(isset($_SESSION['id']))
{
	...
	(fld_name	,fld_email,fld_password,fld_mob,fld_gender,fld_address,fld_logo)
       	values('$r_name','$email','$pswd','$mob','$gender','$address','$logo')");
	       ...
	       <div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="home-tab">
			    ...
			    <form action="" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                         ...
                         <input type="tel" class="form-control" pattern="[0-9]{11}" value="<?php if(isset($mob)) { echo $mob;}?>"id="mob" placeholder="017xxxxxxxx" name="mob" required/>
                     </div>
	                 <div class="form-group">
